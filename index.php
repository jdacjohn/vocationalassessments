<html>
 <head>
  ...
  <title>Vocational Assessments Vocational Evaluations by VIP Services </title>
 ...
 <body>
  <table border="0" cellspacing="0" cellpadding="0" style="background-color: white;">
   <tr>
	...
	<div class="paddit">
	<h3>Our Vocational Appraisal Services</h3>
	...
	<ul class="smaller">
	  ...
	  <li>Vocational expert witness work</li>
	  <li>Student Counseling & Guidance</li>
	  <li>College Major Planning</li>
	  <li>Aptitude Testing</li>
	  <li>Student Assessments</li>
	  <li>Level III Education Assessments</li>
